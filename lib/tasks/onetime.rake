namespace :onetime do
  ...
  task add_all_categories: [:environment] do
    categories = ["Ancient India", "Bollywood", "Cricket", "DIY", "Fashion", "Fitness", "Food Recipe", "Gaming", "General", "Health", "Innovation", "Lifestyle", "Mythology", "Parenting", "Politics", "Sports", "Startups", "Technical", "Travel", "World affairs"]
